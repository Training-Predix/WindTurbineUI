...
module.exports = (config) => {
    ...
    /*console.log('config.uaa.uri: ' + config.uaa.uri);
    console.log('config.uaa.clientId: ' + config.uaa.clientId);
    console.log('config.uaa.clientSecret: ' + config.uaa.clientSecret);
    console.log('config.acsUri: ' + config.acsUri);
    console.log('config.zoneId: ' + config.zoneId);*/
    ...
    acs_utils.isAuthorizedFor = (abacRequest) => {
    	...
    	//console.log('predix-acs-method-----> ' + request.user.details.user_name);
